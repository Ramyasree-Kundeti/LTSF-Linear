...
class TaskDataset(Dataset):
    ...
    def __getitem__(self, key: int) -> Sample:
        ...
        #print("self.observation_time",self.observation_time)
        observations = t <= self.observation_time
        #print("t:", t)
        #print("observation_time:", self.observation_time)
        #print("observations:", observations)
        #print("observations.sum():", observations.sum())
        #print("self.observation_steps ",self.observation_steps)
...
def physionet_collate(batch: list[Sample]) -> Batch:
    ...
    for sample in batch:
        ...
        #print("inside physionet collate ",time.shape)
        #sorted_idx = torch.argsort(time)
        sorted_idx = torch.argsort(t)
        x = x[sorted_idx][-sample.observation_steps:]
        t = t[sorted_idx][-sample.observation_steps:]
...
class Physionet2012(BaseTask):
    ...
    def __init__(
        ...
        #print("self.prediction_steps class Physionet2012(BaseTask) init",self.prediction_steps)
